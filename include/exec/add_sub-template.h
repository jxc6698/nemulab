...
make_helper(concat(ADD_SUB_NAME, _ib2al))
{
	...
	print_asm(ADD_SUB_CMD " $0x%2x,%%al", val2.unsign8);
...
make_helper(concat(ADD_SUB_NAME, _iw2ax))
{
	...
	print_asm(ADD_SUB_CMD " $0x%4x,%%ax", val2.unsign16);
...
make_helper(concat(ADD_SUB_NAME, _il2eax))
{
	...
	print_asm(ADD_SUB_CMD " $0x%8x,%%eax", val2.unsign32);
...
make_helper(concat(ADD_SUB_NAME, _rmb2ib))
{
	ModR_M m;
	eflags_help_s val1, val2, result;
	...
	if (m.mod == 3) {
		...
		print_asm(ADD_SUB_CMD " $0x%2x,%%%s", val2.unsign8, regsb[m.R_M]);
		...
		print_asm(ADD_SUB_CMD " $0x%2x,%%%s", val2.unsign8, ModR_M_asm);
...
make_helper(concat(ADD_SUB_NAME, _rmw2iw))
{
	ModR_M m;
	eflags_help_s val1, val2, result;
	m.val = instr_fetch(eip+1, 1);
	if (m.mod == 3) {
		...
		print_asm(ADD_SUB_CMD " $0x%4x,%%%s", val2.unsign16, regsw[m.R_M]);
		...
		print_asm(ADD_SUB_CMD " $0x%4x,%%%s", val2.unsign16, ModR_M_asm);
...
make_helper(concat(ADD_SUB_NAME, _rml2il))
{
	ModR_M m;
	eflags_help_s val1, val2, result;
	m.val = instr_fetch(eip+1, 1);
	if (m.mod == 3) {
		...
		print_asm(ADD_SUB_CMD " $0x%8x,%%%s", val2.unsign32, regsl[m.R_M]);
		...
		print_asm(ADD_SUB_CMD " $0x%8x,%%%s", val2.unsign32, ModR_M_asm);
...
make_helper(concat(ADD_SUB_NAME, _rmv2iv))
{
	return suffix=='l'?concat(ADD_SUB_NAME, _rml2il)(eip):concat(ADD_SUB_NAME, _rmw2iw)(eip);
}

make_helper(concat(ADD_SUB_NAME, _rmw2ib))
{
	ModR_M m;
	eflags_help_s val1, val2, result;
	m.val = instr_fetch(eip+1, 1);
	if (m.mod == 3) {
		...
		print_asm(ADD_SUB_CMD " $0x%2x,%%%s", val2.sign8, regsw[m.R_M]);
		...
		val2.unsign8 = instr_fetch(eip+len+1, 1);
		val2.sign16 = val2.sign8;
		print_asm(ADD_SUB_CMD " $0x%2x,%s", val2.sign8, ModR_M_asm);
...
make_helper(concat(ADD_SUB_NAME, _rml2ib))
{
	ModR_M m;
	eflags_help_s val1, val2, result;
	m.val = instr_fetch(eip+1, 1);
	if (m.mod == 3) {
		...
		print_asm(ADD_SUB_CMD " $0x%2x,%%%s", val2.sign8, regsl[m.R_M]);
...
make_helper(concat(ADD_SUB_NAME, _rmv2ib))
{
	return suffix=='l'?concat(ADD_SUB_NAME, _rml2ib)(eip):concat(ADD_SUB_NAME, _rmw2ib)(eip);
}
